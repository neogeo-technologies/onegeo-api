...
urlpatterns = [
    ...
    url(r'^indexes/(\d+)/tasks/?$', ContextIDTaskView.as_view()),
    url(r'^indexes/(\d+)/tasks/(\d+)/?$', ContextIDTaskIDView.as_view()),
    url(r'^indexes/(\d+)/?$', ContextIDView.as_view()),
    ...
    url(r'^sources/(\S+)/resources/(\S+)/?$', ResourceIDView.as_view()),  # redev
    url(r'^sources/(\S+)/resources/?$', ResourceView.as_view()),  # redev
    url(r'^sources/(\S+)/?$', SourceIDView.as_view()),  # redev
    url(r'^sources/?$', SourceView.as_view()),  # redev
