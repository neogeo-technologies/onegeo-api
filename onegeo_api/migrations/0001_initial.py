# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2018-01-12 16:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_name', models.CharField(choices=[('Analyzer', 'Analyzer'), ('Context', 'Context'), ('Filter', 'Filter'), ('Resource', 'Resource'), ('SearchModel', 'SearchModel'), ('Source', 'Source'), ('Tokenizer', 'Tokenizer'), ('Undefined', 'Undefined')], default='Undefined', max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='Analyzer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alias', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='onegeo_api.Alias')),
                ('context', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='onegeo_api.Context')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('config', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True, verbose_name='Config')),
                ('alias', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='onegeo_api.Alias')),
                ('contexts', models.ManyToManyField(to='onegeo_api.Context')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_type_alias', models.CharField(default=None, max_length=250, verbose_name='Alias model relation')),
