# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2018-01-25 15:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alias', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='onegeo_api.Alias')),
                ('index_profile', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='onegeo_api.IndexProfile')),
            ],
            options={
